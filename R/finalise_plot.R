...
create_footer <- function (source_name, logo_image_path) {
  ...
  footer <- grid::grobTree(grid::linesGrob(x = grid::unit(c(0, 1), "npc"), y = grid::unit(1.1, "npc")),
                           ...
                           grid::rasterGrob(png::readPNG(logo_image_path), x = 0.99, just="right"))
  return(footer)
...
#'
#' Running this function will save your plot with the correct guidelines for publication for a graphic.
#' It will left align your title, subtitle and source, add blocks at the bottom right and save it to your specified location.
...
#'  which needs to be a PNG file - defaults to image that sits within the data folder of package
...
finalise_plot <- function(plot_name,
                          ...
                          save_filepath=file.path(Sys.getenv("TMP"), "tmp-nc.png"),
                          width_pixels=640,
                          height_pixels=450,
                          logo_image_path = file.path(system.file("extdata", package = 'ropenfisheries'),"placeholder.png")) {
